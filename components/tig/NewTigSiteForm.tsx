...
import { createTigSiteAction } from '@/app/sigep/dashboard/tig-sites/actions';
...
export default function NewTigSiteForm() {
      ...
      <form action={formAction} className="space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input name="contact_phone" type="tel" placeholder="+226 XX XX XX XX" pattern="[\+\d\s\-]{7,20}" title="Format : +226 XX XX XX XX" className={INPUT} />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input name="capacity" type="number" required min={1} max={100} defaultValue={4} className={INPUT} />
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-4">
          ...
          <p className="text-[10px] text-gray-400">
            ...
            Ces coordonnées permettront de créer la géofence du site dans SIGEP.
          </p>
        </div>
