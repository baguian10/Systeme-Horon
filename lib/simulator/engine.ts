...
export class SimulatorEngine {
  ...
  injectAlert(type?: AlertType) {
    ...
    const SEVERITY_MAP: Record<AlertType, number> = {
      ...
      GEOFENCE_EXIT: 4, BLE_EXIT: 4, CURFEW_VIOLATION: 4, HEALTH_CRITICAL: 3,
    ...
    const DESCRIPTION_MAP: Record<AlertType, string> = {
      ...
      BLE_EXIT: `Sortie du périmètre domicile (balise BLE) détectée à ${new Date().toLocaleTimeString('fr-FR')}.`,
